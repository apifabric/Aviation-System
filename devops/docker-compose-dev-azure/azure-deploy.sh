...
resourcename="aviationsystem"  # lower case, only
resourcegroup="aviationsystem_rg"
...
# git clone https://github.com/apilogicserver/aviationsystem.git
# cd aviationsystem
...
az group create --name aviationsystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group aviationsystem_rg --sku S1 --is-linux
az container create --resource-group aviationsystem_rg --name aviationsystem --image apilogicserver/aviationsystem:latest --dns-name-label aviationsystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//aviationsystem.westus.azurecontainer.io:5656'
