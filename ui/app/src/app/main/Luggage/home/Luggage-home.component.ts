...
@Component({
  selector: 'Luggage-home',
  templateUrl: './Luggage-home.component.html',
  styleUrls: ['./Luggage-home.component.scss']
})
export class LuggageHomeComponent implements AfterViewInit {
