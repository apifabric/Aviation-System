...
@Component({
  selector: 'PilotLicense-home',
  templateUrl: './PilotLicense-home.component.html',
  styleUrls: ['./PilotLicense-home.component.scss']
})
export class PilotLicenseHomeComponent implements AfterViewInit {
