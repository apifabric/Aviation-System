...
@Component({
  selector: 'AircraftMaintenance-home',
  templateUrl: './AircraftMaintenance-home.component.html',
  styleUrls: ['./AircraftMaintenance-home.component.scss']
})
export class AircraftMaintenanceHomeComponent implements AfterViewInit {
